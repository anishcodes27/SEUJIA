    ...
    <div className="min-h-screen bg-gradient-to-br from-honey-50 via-white to-honey-100 flex items-center justify-center px-4 py-12 pt-32">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-honey-900 mb-2">Welcome Back</h1>
          <p className="text-honey-600">Sign in to your account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-honey-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-honey-600 to-honey-700 text-white font-semibold py-3 px-6 rounded-lg hover:from-honey-700 hover:to-honey-800 transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-honey-600">Don't have an account?</span>
            </div>
          </div>
